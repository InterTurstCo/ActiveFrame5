...
@Component
@Scope("prototype")
public class PostgresCreateBackupTask implements Task {

    protected static Logger logger = LoggerFactory.getLogger(PostgresCreateBackupTask.class);
    ...
    public TaskResult call() throws Exception {
        postgresService.create(context.getEar());
