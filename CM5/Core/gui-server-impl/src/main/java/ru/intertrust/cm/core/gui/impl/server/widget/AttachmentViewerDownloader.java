...
import static ru.intertrust.cm.core.business.api.dto.util.ModelConstants.DOWNLOAD_EQUAL;
import static ru.intertrust.cm.core.business.api.dto.util.ModelConstants.DOWNLOAD_ID;
import static ru.intertrust.cm.core.business.api.dto.util.ModelConstants.DOWNLOAD_TEMP_NAME;
 ...
 */
@Controller
public class AttachmentViewerDownloader {
    ...
    @RequestMapping(value = "attachment-viewer-download", method = RequestMethod.GET)
