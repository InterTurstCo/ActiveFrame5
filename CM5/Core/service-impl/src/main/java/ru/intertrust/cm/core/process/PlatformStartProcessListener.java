...
public class PlatformStartProcessListener implements ExecutionListener {
    ...
    @PostConstruct
    public void init(){
        globalListeners.addStartProcessListener(GlobalListeners.NBR_PROCESS_TARGET_NAMESPACE, this);
    }

    @Override
    public void notify(DelegateExecution execution) {
        logger.debug("Start process {}", execution.getProcessDefinitionId());
    }
}
