...
*/
     ...
     * @throws Exception
     */
    private File generateReport(ReportMetadataConfig reportMetadata, File templateFolder, Map<String, Object> reportParams)
            throws Exception {
        
        //Если параметры не переданы создаем пустую map
        Map<String, Object> params = reportParams;
        if (params == null){
