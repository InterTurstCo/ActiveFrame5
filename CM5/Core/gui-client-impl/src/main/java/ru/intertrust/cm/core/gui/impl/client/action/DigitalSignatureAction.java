...
public class DigitalSignatureAction extends Action {
    ...
    private void signData(final DigitalSignatureConfig digitalSignatureConfig) {
        ...
        digitalSignatureService.getSignedData(id, new AsyncCallback<SignedData>() {
            ...
            @Override
            public void onSuccess(final SignedData result) {
                try {
                    ...
                    component.init(digitalSignatureConfig, new DigitalSignatureComponentInitHandler() {
                        ...
                        public void onInit() {
                            try {
                                int progressValue = 0;
                                for (SignedDataItem signedData : result.getSignedDataItems()) {
