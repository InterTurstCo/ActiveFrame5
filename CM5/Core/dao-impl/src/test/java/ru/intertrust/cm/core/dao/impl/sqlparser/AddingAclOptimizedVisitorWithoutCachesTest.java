 ...
 */
public class AddingAclOptimizedVisitorWithoutCachesTest extends AddingAclOptimizedVisitorWithCachesTest {

    @Before
    @Override
    public void setUp() {
        AddingAclOptimizedVisitor.clearCache();
        super.setUp();
    }
