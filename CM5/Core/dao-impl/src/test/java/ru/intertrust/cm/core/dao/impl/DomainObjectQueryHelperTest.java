...
public class DomainObjectQueryHelperTest {
    ...
    private static final String ACCESS_RIGHTS_PART2 = " and exists (select a.object_id from person_read a  " +
            "inner join \"group_group\" gg on a.\"group_id\" = gg.\"parent_group_id\" "
            + "inner join \"group_member\" gm on gg.\"child_group_id\" = gm.\"usergroup\" "
            + "inner join \"person\" o on (o.\"access_object_id\" = a.\"object_id\") where gm.person_id = :user_id and o.id = :id)";

    private static final String ACCESS_RIGHTS_PART3 = " and exists (select a.object_id from user_group_read a  " +
            "inner join \"group_group\" gg on a.\"group_id\" = gg.\"parent_group_id\" "
            + "inner join \"group_member\" gm on gg.\"child_group_id\" = gm.\"usergroup\" "
    ...
    public void testGenerateFindPersonsInGroupQuery() throws Exception {
        ...
        String expectedQuery = "select person.* from \"person\" person inner join \"group_member\" gm on " +
                ...
                "gm.\"usergroup\"=:id and gm.\"usergroup_type\"=:id_type" + ACCESS_RIGHTS_PART2;
        Assert.assertEquals(expectedQuery, domainObjectQueryHelper.generateFindPersonsInGroupQuery("Person", accessToken));
    }
    ...
    public void testGenerateFindAllPersonsInGroupQuery() throws Exception {
        ...
        String expectedQuery = "select person.* from \"person\" person inner join \"group_member\" gm on " +
                ...
                "where gg.\"parent_group_id\"=:id and gg.\"parent_group_id_type\"=:id_type" + ACCESS_RIGHTS_PART2;
        Assert.assertEquals(expectedQuery, domainObjectQueryHelper.generateFindAllPersonsInGroupQuery("Person", accessToken));
    }
    ...
    public void testGenerateFindPersonGroups() throws Exception {
        ...
        String expectedQuery = "select user_group.* from \"user_group\" user_group  inner join \"group_group\" gg on " +
                ...
                "where gm.\"person_id\"=:id and gm.\"person_id_type\"=:id_type" + ACCESS_RIGHTS_PART3;
        Assert.assertEquals(expectedQuery, domainObjectQueryHelper.generateFindPersonGroups("User_Group", accessToken));
    }
    ...
    public void testGenerateFindAllParentGroups() throws Exception {
        ...
        String expectedQuery = "select user_group.* from \"user_group\" user_group  inner join \"group_group\" gg on " +
                ...
                "(\"user_group\".\"id\" <> :id or \"user_group\".\"id_type\" <> :id_type)" + ACCESS_RIGHTS_PART3;
        Assert.assertEquals(expectedQuery, domainObjectQueryHelper.generateFindAllParentGroups("User_Group", accessToken));
    }
    ...
    public void testGenerateFindChildGroups() throws Exception {
        ...
        String expectedQuery = "select user_group.* from \"user_group\" user_group  inner join \"group_group_settings\" ggs on " +
                ...
                "where ggs.\"parent_group_id\"=:id and ggs.\"parent_group_id_type\"=:id_type" + ACCESS_RIGHTS_PART3;
        Assert.assertEquals(expectedQuery, domainObjectQueryHelper.generateFindChildGroups("User_Group", accessToken));
    }
    ...
    public void tesGenerateFindAllChildGroups() throws Exception {
        ...
        String expectedQuery = "select user_group.* from \"user_group\" user_group  inner join \"group_group\" gg on " +
                ...
                "(\"user_group\".\"id\" <> :id or \"user_group\".\"id_type\" <> :id_type)" + ACCESS_RIGHTS_PART3;
        Assert.assertEquals(expectedQuery, domainObjectQueryHelper.generateFindAllChildGroups("User_Group", accessToken));
    }
    ...
    public void tesGenerateFindDynamicGroup() throws Exception {
        ...
        String expectedQuery = "select user_group.* from \"user_group\" user_group " +
                ...
                "\"user_group\".\"group_name\"=:name" + ACCESS_RIGHTS_PART3;
        Assert.assertEquals(expectedQuery, domainObjectQueryHelper.generateFindDynamicGroup("User_Group", accessToken));
    }
