...
public class CollectDOTypesVisitorTest {
    ...
    public void testFindDOTypesSelectItemSubQuery() throws Exception {
        ...
        Set<String> expected = new HashSet<>(asList("t", "x"));
        assertEquals(expected, types);
    }
    ...
    public void testAddChildTypesToo() {
        ...
        Set<String> expected = new HashSet<>(asList("xchild", "xgrandchild"));
        assertEquals(expected, types);
    }
    ...
    public void testQuotedTableNames() {
        ...
        Set<String> expected = new HashSet<>(asList("x"));
        assertEquals(expected, types);
    }
    ...
    public void testMixedCaseType() {
        ...
        Set<String> expected = new HashSet<>(asList("mixedcase"));
        assertEquals(expected, types);
    }
    ...
    public void testInSubquery() {
        ...
        Set<String> expected = new HashSet<>(asList("x", "y"));
        assertEquals(expected, types);
    }
    ...
    public void testCaseSubquery() {
        ...
        Set<String> expected = new HashSet<>(asList("x", "y", "z"));
        assertEquals(expected, types);
    }
    ...
    public void testDOsWithNotDoTables() {
        configurationExplorer.createTypeConfig((new TypeConfigBuilder("x")));
        Set<String> types = visitor.getDOTypes("select * from x natural join y");
        Set<String> expected = new HashSet<>(asList("x"));
        assertEquals(expected, types);
    }
    ...
    public void testMulticolumnIn() {
        configurationExplorer.createTypeConfig((new TypeConfigBuilder("x")));
        configurationExplorer.createTypeConfig((new TypeConfigBuilder("y")));
        Set<String> types = visitor.getDOTypes("select * from x where (x.id, x.id_type) in (select x, x_type from y)");
        Set<String> expected = new HashSet<>(asList("x", "y"));
        assertEquals(expected, types);
    }
