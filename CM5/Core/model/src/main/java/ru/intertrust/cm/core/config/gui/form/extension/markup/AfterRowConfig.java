 ...
 */
@Root(name = "after-tr")
public class AfterRowConfig implements IdentifiedFormExtensionOperation<RowConfig> {
    @Attribute(name = "id")
    private String id;
    ...
    public void setSource(List<RowConfig> rowsConfigs) {
        this.source = rowsConfigs;
    }
    @Override
    ...
    public boolean equals(Object o) {
        ...
        AfterRowConfig that = (AfterRowConfig) o;
