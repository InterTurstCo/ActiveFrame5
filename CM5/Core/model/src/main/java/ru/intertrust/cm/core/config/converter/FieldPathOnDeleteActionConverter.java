...
public final class FieldPathOnDeleteActionConverter implements org.simpleframework.xml.convert.Converter<FieldPathConfig> {
    ...
    public FieldPathConfig read(InputNode node) throws Exception {
        ...
        while ((nexNode = node.getNext()) != null) {
            ...
            } else if ("default-value".equals(nexNode.getName())) {
                DefaultValueConfig defaultValueConfig = serializer.read(DefaultValueConfig.class, nexNode);
                result.setDefaultValueConfig(defaultValueConfig);
            } else if ("default-values".equals(nexNode.getName())) {
                DefaultValuesConfig defaultValuesConfig = serializer.read(DefaultValuesConfig.class, nexNode);
                result.setDefaultValuesConfig(defaultValuesConfig);
            }
        }
        return result;
    }
    ...
    public void write(OutputNode node, FieldPathConfig fieldPathConfig) throws Exception {
        ...
        if (fieldPathConfig.getDefaultValueConfig() != null) {
            serializer.write(fieldPathConfig.getDefaultValueConfig(), node);
        }

        if (fieldPathConfig.getDefaultValuesConfig() != null) {
            serializer.write(fieldPathConfig.getDefaultValuesConfig(), node);
        }
