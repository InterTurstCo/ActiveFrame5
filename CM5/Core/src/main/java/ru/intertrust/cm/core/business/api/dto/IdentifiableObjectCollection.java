 ...
 * Time: 10:54
 */
public class IdentifiableObjectCollection implements Iterable<IdentifiableObject> {
    ...
    private class FastIdentifiableObjectImpl implements IdentifiableObject {
        ...
        @Override
        public ArrayList<String> getFields() {
            return IdentifiableObjectCollection.this.getFields();
        }
    ...
    public static void main(String[] args) {
        ...
        IdentifiableObjectCollection collection = new IdentifiableObjectCollection();
