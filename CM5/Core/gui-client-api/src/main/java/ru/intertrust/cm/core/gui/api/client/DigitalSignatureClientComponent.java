...
public abstract class DigitalSignatureClientComponent extends BaseComponent{
    ...
    /**
     * Подписать контент. 
     * @param сontent контент может присылатся весь в формате base64 или только его hash в формате base16, в зависимости от настроек сервера 
     * CryptoSettingsConfig.getHashOnServer()
     * @return возвращает ЭП в формате base64
     */
    public abstract String sign(String сontent);
