 ...
 *         Time: 20:21
 */
public class SearchAreaConfig extends PluginConfig {
    private Id domainObjectId;
    private String domainObjectTypeToCreate;
//    private FormPluginMode mode;
    private boolean editable;

    public SearchAreaConfig() {
    }

    public SearchAreaConfig(Id domainObjectId) {
        this.domainObjectId = domainObjectId;
    }

    public SearchAreaConfig(String domainObjectTypeToCreate) {
