 ...
 */
public class ExceptionAfterFirstStepTest extends ClientBase {

    public static void main(String[] args) throws Exception {
        ExceptionAfterFirstStepTest oneStepProcessTest = new ExceptionAfterFirstStepTest();
    ...
    protected void execute(String[] args) throws Exception {
        ...
        String id = getProcessService("person2").startProcess("exception-after-first-step", attachment.getId(), null);
