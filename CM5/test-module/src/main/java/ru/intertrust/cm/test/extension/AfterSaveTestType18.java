...
@ExtensionPoint(filter = "test_type_18")
public class AfterSaveTestType18 implements AfterSaveExtensionHandler {
    @Autowired
    ...
    public void onAfterSave(DomainObject domainObject, List<FieldModification> changedFields) {
        ...
        IdentifiableObjectCollection collection = collectionsService.findCollectionByQuery("select * from test_type_18 where id = {0}", params);
