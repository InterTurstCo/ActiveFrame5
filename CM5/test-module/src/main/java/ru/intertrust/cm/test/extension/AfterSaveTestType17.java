...
@ExtensionPoint(filter = "test_type_17")
public class AfterSaveTestType17 implements AfterSaveExtensionHandler {
    @Autowired
    ...
    public void onAfterSave(DomainObject domainObject, List<FieldModification> changedFields) {
        ...
        IdentifiableObjectCollection collection = collectionsService.findCollectionByQuery("select * from test_type_17 where id = {0}", params);
